package com.example.policyspoon.base.config;

import com.example.policyspoon.base.filter.CustomLogoutFilter;
import com.example.policyspoon.base.filter.JwtExceptionFilter;
import com.example.policyspoon.base.filter.JwtFilter;
...
public class SecurityConfig {
    ...
    private final String[] COMMON_WHITE_LIST = new String[]
            {
                    "/**", "/login/**", "/oauth2/**", "/error/**", "/ws/**", "/favicon.ico/**", "/swagger-ui/**", "/v3/**"
            };
